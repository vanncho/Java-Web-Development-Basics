            ...
            <form class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="text" name="title" id="article-title" placeholder="Article Title" required="required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="article-content">Content</label>
                        <div class="col-sm-4">
                            <textarea class="form-control" rows="7" id="article-content" name="content"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
