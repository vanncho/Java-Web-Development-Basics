...
import com.server.http.response.HttpCookieImpl;
...
public class HttpRequestImpl implements HttpRequest {
    ...
    private void parseRequest(String requestString, Map<String, HttpSession> sessionMap) throws BadRequestException, UnsupportedEncodingException {
        ...
        if (requestLine.length != 3 || !requestLine[2].toLowerCase().equals(Constants.HTTP_VERSION)) {

            throw new BadRequestException(Constants.INVALID_REQUEST_LINE_MESSAGE);
        }
    ...
    private void parseHeaders(String[] requestLines) throws BadRequestException {
        ...
        if (!this.headers.containsKey("Host")) {
            ...
            throw new BadRequestException(Constants.INVALID_HEADERS_MESSAGE);
        }
    }
